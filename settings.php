 ...
 * @endcode
 */
$settings['hash_salt'] = 'DN-AXMr8i2NoOMmG1uX6J_oH3HAP3qMCgcj92zwfso9-b1UqjMxDXlhMidCc__xtTLCGzZAsfw';
...
$databases['default']['default'] = array (
  ...
  'init_commands' => array(
    'isolation_level' => "SET SESSION tx_isolation='" . (getenv('DB_ISOLATION_LEVEL') ?: 'READ-COMMITTED') . "'",
  ),
);

// $settings['config_sync_directory'] = 'sites/default/files/config_DuZsmHiFpSXk0lGx-ZwdSvq9zn1wLHoHPm8M-dtdRgQjotodvdZ0wYPLbKCWCNKsHLoxqdr4EQ/sync';

// Interfase config folders
...
// Interfase config, local setting
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
   include $app_root . '/' . $site_path . '/settings.local.php';
 }
...
$conf['devel_debug_mail_directory'] = '/database'; */
